  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050508', color: 'white', position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <p style={{ color: '#888', marginBottom: '50px', fontSize: '1.1rem' }}>AI-powered documentation generation</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px' }}>
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '30px' }}>
            ...
            <div>
              ...
              {generatedContent && (
                <>
                  <button onClick={downloadPDF} style={{ padding: '14px 28px', fontSize: '1rem', fontWeight: 500, cursor: 'pointer', border: 'none', borderRadius: '8px', marginRight: '12px', background: 'transparent', color: 'white', border: '1px solid rgba(255,255,255,0.2)' }}>⬇️ PDF</button>
                  <button onClick={downloadMarkdown} style={{ padding: '14px 28px', fontSize: '1rem', fontWeight: 500, cursor: 'pointer', border: 'none', borderRadius: '8px', background: 'transparent', color: 'white', border: '1px solid rgba(255,255,255,0.2)' }}>⬇️ Markdown</button>
                </>
              )}
            </div>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '30px', position: 'sticky', top: '80px' }}>
            <div style={{ fontSize: '0.85rem', color: '#888', marginBottom: '20px', letterSpacing: '1px' }}>// {generatedContent ? 'AI GENERATED DOC PREVIEW' : 'PREVIEW'}</div>
            
            {generatedContent ? (
              <div ref={pdfRef} style={{ background: 'white', color: '#333', borderRadius: '8px', padding: '24px', minHeight: '400px', fontFamily: 'Georgia, serif' }}>
                <div style={{ textAlign: 'center', marginBottom: '30px', paddingBottom: '20px', borderBottom: '2px solid #1a1a2e' }}>
                  <h1 style={{ color: '#1a1a2e', fontSize: '1.3rem', marginBottom: '10px' }}>{projectName}</h1>
                  <p style={{ color: '#666', fontSize: '0.9rem', fontStyle: 'italic' }}>{docType}</p>
                </div>
              ...
              <div style={{ background: 'white', color: '#333', borderRadius: '8px', padding: '24px', minHeight: '400px', fontFamily: 'Georgia, serif' }}>
